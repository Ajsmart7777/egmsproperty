      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/request/:id" element={<ProtectedRoute><AppLayout><RequestDetail /></AppLayout></ProtectedRoute>} />
            <Route path="/settings" element={<ProtectedRoute><AppLayout><Settings /></AppLayout></ProtectedRoute>} />
            <Route path="/profile" element={<ProtectedRoute><AppLayout><Profile /></AppLayout></ProtectedRoute>} />
            <Route path="/privacy-security" element={<ProtectedRoute><AppLayout><PrivacySecurity /></AppLayout></ProtectedRoute>} />
            <Route path="/help-support" element={<ProtectedRoute><AppLayout><HelpSupport /></AppLayout></ProtectedRoute>} />
            ...
            <Route path="/admin/audit-logs" element={<ProtectedRoute><AppLayout><AuditLogs /></AppLayout></ProtectedRoute>} />
            <Route path="/vendor" element={<ProtectedRoute><AppLayout><VendorDashboard /></AppLayout></ProtectedRoute>} />
            <Route path="/vendor/profile" element={<ProtectedRoute><AppLayout><VendorProfile /></AppLayout></ProtectedRoute>} />
